...
import com.foodsaver.app.presentation.ProfileMenu.Locale
...
private fun ProfileMenuScreen(
    ...
    DropdownMenu(
        ...
        DropdownMenuItem(
            onClick = {
                onEvent(ProfileEvent.OnChangleLocaleClick(Locale.ENGLISH))
                isDropDownMenuExpanded = false
            },
            text = {
                Text(
        ...
        DropdownMenuItem(
            onClick = {
                onEvent(ProfileEvent.OnChangleLocaleClick(Locale.RUSSIAN))
                isDropDownMenuExpanded = false
            },
            text = {
                Text(
        ...
        Column(
            ...
            Card(
                colors = CardDefaults.cardColors(
                    containerColor = com.foodsaver.app.ui.FoodSaverTheme.colorScheme.tertiary
                ),
