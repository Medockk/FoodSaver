    ...
    val dialogContent = @Composable {
        Column(
            modifier = modifier
                ...
                .background(com.foodsaver.app.ui.FoodSaverTheme.colorScheme.background, RoundedCornerShape(15.dp))
            ...
            TextButton(
                ...
                colors = ButtonDefaults.textButtonColors(
                    contentColor = com.foodsaver.app.ui.FoodSaverTheme.colorScheme.primary
                )
            ) {
                Text(
                    text = stringResource(Res.string.save)
