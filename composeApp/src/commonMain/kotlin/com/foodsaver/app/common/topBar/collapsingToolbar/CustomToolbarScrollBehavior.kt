package com.foodsaver.app.common.topBar.collapsingToolbar
...
@Composable
fun rememberToolbarScrollBehavior(state: CustomToolbarScrollState? = null) = CustomToolbarScrollBehavior(
    state = state ?: rememberToolbarScrollState(
