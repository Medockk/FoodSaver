...
import com.foodsaver.app.coreEnterprises.data.dto.EnterpriseImagesDto
...
internal class EnterprisesRepositoryImpl(
    ...
    override suspend fun getNearestEnterprises(userLocationModel: UserLocationModel): ApiResult<List<RestaurantModel>> {
    ...
    override suspend fun getEnterpriseById(enterpriseId: String): ApiResult<RestaurantModel?> {
