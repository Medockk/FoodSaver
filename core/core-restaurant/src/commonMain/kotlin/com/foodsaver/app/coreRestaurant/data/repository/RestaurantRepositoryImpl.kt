...
//        }
    ...
    override suspend fun uploadRestaurantImage(image: ByteArray, restaurantId: String?): ApiResult<String> =
        withContext(Dispatchers.InputOutput) {
                        ...
                        MultiPartFormDataContent(
                            parts = formData {
                                append("file", image, Headers.build {
                                    ...
                                    append(HttpHeaders.ContentDisposition, "filename=\"restaurantImage.png\"")
                                })
                            }
                        ))
    ...
    override suspend fun upsertRestaurant(request: UpsertRestaurantRequest): ApiResult<RestaurantModel> {
        return withContext(Dispatchers.InputOutput) {
            saveNetworkCall<RestaurantDto> {
                httpClient.post(HttpConstants.ENTERPRISE_URL + "/add") {
